...
const siteCopyEs: SiteCopy = {
  ...
  holidayRental: {
    ...
    technologyNote: "La gestión documental puede apoyarse en Anclora GuestHub para estructurar datos de reservas orientados al flujo SES.HOSPEDAJES. Esta capa aporta trazabilidad y menos fricción documental; no sustituye la revisión legal ni el criterio del profesional.",
...
const siteCopyEn: SiteCopy = {
  ...
  holidayRental: {
    ...
    technologyNote: "Documentary operations can be supported by Anclora GuestHub to structure booking data oriented to the SES.HOSPEDAJES flow. This layer adds traceability and less documentary friction; it does not replace legal review or professional judgment.",
...
const siteCopyFr: SiteCopy = {
  ...
  holidayRental: {
    ...
    technologyNote: "La gestion documentaire peut s'appuyer sur Anclora GuestHub pour structurer les données de réservation orientées vers le flux SES.HOSPEDAJES. Cette couche apporte traçabilité et moins de friction documentaire ; elle ne remplace pas l'examen juridique ni le jugement du professionnel.",
...
const siteCopyCa: SiteCopy = {
  ...
  holidayRental: {
    ...
    technologyNote: "La gestió documental pot recolzar-se en Anclora GuestHub per estructurar dades de reserves orientades al flux SES.HOSPEDAJES. Aquesta capa aporta traçabilitat i menys fricció documental; no substitueix la revisió legal ni el criteri del professional.",
